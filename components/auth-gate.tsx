...
import { getFirebaseAuth, signInWithGoogle, signOutCurrentUser } from "@/lib/auth/firebase-client";
...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Firebase configuration is missing.");
      setLoading(false);
    }
    return () => unsubscribe();
  }, []);
